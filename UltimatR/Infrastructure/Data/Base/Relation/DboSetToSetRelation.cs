...
namespace UltimatR
{
    public class DboSetToSetRelation<TLeft, TRight> where TLeft : Entity where TRight : Entity
    {
        ...
        public DboSetToSetRelation(ModelBuilder modelBuilder, ExpandSite expandSite = ExpandSite.OnRight, string dbSchema = null)
           : this(modelBuilder, null, null, null, null, expandSite, dbSchema, dbSchema) { }

        public DboSetToSetRelation(ModelBuilder modelBuilder, string leftName, string rightName, ExpandSite expandSite = ExpandSite.OnRight, string dbSchema = null)
            : this(modelBuilder, leftName, leftName, rightName, rightName, expandSite, dbSchema, dbSchema) { }

        public DboSetToSetRelation(ModelBuilder modelBuilder, 
                                       string leftName,
