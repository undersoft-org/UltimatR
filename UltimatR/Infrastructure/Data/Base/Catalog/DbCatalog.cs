...
namespace UltimatR
{
    public static class DbCatalog
    {
        ...
        public static IDeck<PropertyInfo> GetDbProperties(this DbContext context)
        {
            ...
            if(!Properties.TryGet(contextType, out IDeck<PropertyInfo> dbSetProperties))
            {
                ...
                foreach(var property in properties)
                {
                    ...
                    var isDbSet = setType.IsGenericType && (typeof(DbSet<>)
        ...
        public static IDeck<IEntityType> GetDbEntities(this DbContext context)
        {
            var contextType = context.GetType();
        ...
        public static IDeck<MemberRubric[]> GetDbRemotes(this DbContext context)
        {
            var contextType = context.GetType();
            ...
            foreach (var entity in entities)
            {
                var remoteProperties = entity.ClrType.GetProperties()
                                            ...
                                            .Any(a => a.AttributeType == typeof(DataServiceAttribute) ||
                                                       a.AttributeType == typeof(LinkedAttribute))).ToArray();
        ...
        public static Type GetDbStore(this DsContext context)
        {
        ...
        public static IDeck<IDeck<PropertyInfo[]>> GetDbIndentities(this DbContext context)
        {
        ...
        public static PropertyInfo GetProperty(this DbContext context, string entityTypeName)
        {
            return GetProperty(context, Type.GetType(entityTypeName));
        }
        public static PropertyInfo GetProperty(this DbContext context, Type entityType)
        {
            if (GetDbProperties(context).TryGet(entityType, out PropertyInfo dbSetProperty))
                return dbSetProperty;
            return null;
        }
        public static PropertyInfo GetProperty<TEntity>(this DbContext context)
        {
           return GetProperty(context, typeof(TEntity));
        }

        public static IEntityType GetEntityType(this DbContext context, string entityTypeName)
        {
            if(GetDbEntities(context).TryGet(entityTypeName, out IEntityType dbEntityType))
                return dbEntityType;
            return null;
        }
        public static IEntityType GetEntityType(this DbContext context, Type entityType)
        {
            if(GetDbEntities(context).TryGet(entityType.Name, out IEntityType dbEntityType))
                return dbEntityType;
            return null;
        }
        public static IEntityType GetEntityType<TEntity>(this DbContext context)
        {
        ...
        public static object GetDbSet(this DbContext context, string entityTypeName)
        {
        ...
        public static DbSet<TEntity> GetDbSet<TEntity>(this DbContext context) where TEntity : class, IIdentifiable
        {
