...
namespace UltimatR
{
        ...
        where TStore : IDataStore
    {
        ...
        protected DtoController(IUltimatr ultimatr, PublishMode publishMode = PublishMode.PropagateCommand) { _ultimatr = ultimatr; _publishMode = publishMode; }

        protected DtoController(IUltimatr ultimatr, Func<TKey, Expression<Func<TEntity, bool>>> keymatcher, PublishMode publishMode = PublishMode.PropagateCommand)
        ...
        public virtual async Task<IActionResult> Delete([FromBody] TDto[] dtos)
        {
            ...
            DtoCommandSet<TDto> result = await _ultimatr.Send(
                new DeleteDtoSet<TStore, TEntity, TDto>(_publishMode, dtos))
        ...
        public virtual async Task<IActionResult> Delete(TKey key, [FromBody] TDto dto)
        {
            ...
            DtoCommand<TDto> result = await _ultimatr.Send(
                new DeleteDto<TStore, TEntity, TDto>(_publishMode, dto, key))
                .ConfigureAwait(false);
        ...
        { return Ok(await _ultimatr.Send(new GetDto<TStore, TEntity, TDto>()).ConfigureAwait(false)); }
        ...
        public virtual async Task<IActionResult> Patch([FromBody] TDto[] dtos)
        {
            ...
            DtoCommandSet<TDto> result = await _ultimatr.Send(
                new ChangeDtoSet<TStore, TEntity, TDto>(_publishMode, dtos))
                .ConfigureAwait(false);
        ...
        public virtual async Task<IActionResult> Patch(TKey key, [FromBody] TDto dto)
        {
            ...
            DtoCommand<TDto> result = await _ultimatr.Send(
                new ChangeDto<TStore, TEntity, TDto>(_publishMode, dto, key))
                .ConfigureAwait(false);
        ...
        public virtual async Task<IActionResult> Post([FromBody] TDto[] dtos)
        {
            ...
            DtoCommandSet<TDto> result = await _ultimatr.Send(
                new CreateDtoSet<TStore, TEntity, TDto>(_publishMode, dtos))
                .ConfigureAwait(false);
        ...
        public virtual async Task<IActionResult> Post(TKey key, [FromBody] TDto dto)
        {
            ...
            DtoCommand<TDto> result = await _ultimatr.Send(
                new CreateDto<TStore, TEntity, TDto>(_publishMode, dto, key))
                .ConfigureAwait(false);
        ...
        public virtual async Task<IActionResult> Put([FromBody] TDto[] dtos)
        {
            ...
            DtoCommandSet<TDto> result = await _ultimatr.Send(
                new UpdateDtoSet<TStore, TEntity, TDto>(_publishMode, dtos))
                .ConfigureAwait(false);
        ...
        public virtual async Task<IActionResult> Put(TKey key, [FromBody] TDto dto)
        {
            ...
            DtoCommand<TDto> result = await _ultimatr.Send(
                new UpdateDto<TStore, TEntity, TDto>(_publishMode, dto, key))
                .ConfigureAwait(false);
