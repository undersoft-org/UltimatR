...
namespace UltimatR
{ 
    public class DsoToSetLazy<TRemote> : Lazy<DsoSet<TRemote>>, ICollection<TRemote>, IEnumerable<TRemote>, IFindable,
                                       ...
                                       ICollection, IList where TRemote : class, IIdentifiable
    {
        ...
        public DsoToSetLazy(bool isThreadSafe) : base(isThreadSafe)
        {
        }
       
        public DsoToSetLazy(Func<DsoSet<TRemote>> valueFactory) : base(valueFactory)
        {
        }

        public DsoToSetLazy(Func<DsoSet<TRemote>> valueFactory, bool isThreadSafe) : base(valueFactory, isThreadSafe)
        {
        }

        public DsoToSetLazy(Func<DsoSet<TRemote>> valueFactory, LazyThreadSafetyMode mode) : base(valueFactory, mode)
        {
        }

        public DsoToSetLazy(LazyThreadSafetyMode mode) : base(mode)
        {
        }

        public DsoToSetLazy(DsoSet<TRemote> value) : base(value)
        {
        }
