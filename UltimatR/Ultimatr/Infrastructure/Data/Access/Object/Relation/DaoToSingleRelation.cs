...
namespace UltimatR
{
    public class DaoToSingleRelation<TParent, TChild> where TParent : Entity where TChild : Entity
    {
        ...
        public DaoToSingleRelation(ModelBuilder modelBuilder, ExpandSite expandSite = ExpandSite.OnRight, string parentSchema = null)
         : this(modelBuilder, null, null, null, null, expandSite, parentSchema, parentSchema) { }

        public DaoToSingleRelation(ModelBuilder modelBuilder, string parentName, string childName, ExpandSite expandSite = ExpandSite.OnRight, string parentSchema = null)
            : this(modelBuilder, parentName, null, childName, null, expandSite, parentSchema, parentSchema) { }

        public DaoToSingleRelation(ModelBuilder modelBuilder,
                                       string parentName,
