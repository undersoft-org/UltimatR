...
namespace UltimatR
{
    /// <summary>
    /// Class EventSet.
    /// Implements the <see cref="System.Series.Deck{UltimatR.Event{TCommand}}" />
    /// Implements the <see cref="MediatR.INotification" />
    /// </summary>
    /// <typeparam name="TCommand">The type of the t command.</typeparam>
    /// <seealso cref="System.Series.Deck{UltimatR.Event{TCommand}}" />
    /// <seealso cref="MediatR.INotification" />
    public abstract class EventSet<TCommand> : Deck<Event<TCommand>>, INotification where TCommand : Command
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventSet{TCommand}"/> class.
        /// </summary>
        /// <param name="publishPattern">The publish pattern.</param>
        /// <param name="commands">The commands.</param>
        protected EventSet(PublishMode publishPattern, Event<TCommand>[] commands) : base(commands)
        {
