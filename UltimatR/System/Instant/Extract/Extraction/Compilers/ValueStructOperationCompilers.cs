//-----------------------------------------------------------------------
// <copyright file="ValueStructOperationCompilers.cs" company="Undersoft">
//     Author: Dariusz Hanc
...
namespace System.Extract
{
    ...
    public static partial class Extraction
    {
        public static void CompileByteArrayToValueObject(TypeBuilder tb)
        {
            ...
            MethodInfo method_IntPtr_op_Explicit = typeof(IntPtr).GetMethods()
        ...
        public static void CompileValueObjectToNewPointer(TypeBuilder tb)
        {
            ...
            tb.DefineMethodOverride(
                structToPtrMethod,
                typeof(IExtractor).GetMethod("ValueStructureToPointer", new Type[] { typeof(object) }));
        }
        ...
        public static void CompileValueTypeToNewByteArray(TypeBuilder tb)
        {
            ...
            tb.DefineMethodOverride(
                structToPtrMethod,
                typeof(IExtractor).GetMethod("ValueStructureToBytes", new Type[] { typeof(ValueType) }));
        }
    }
}
