...
namespace System.Instant.Stock
{
    ...
    public class UnsafeNativeMethods
    {
        ...
        internal static string GetMessage(int errorCode)
        {
            ...
            if (UnsafeNativeMethods.FormatMessage(12800, IntPtr.Zero, errorCode, 0, stringBuilder, stringBuilder.Capacity,
                    IntPtr.Zero) != 0)
            {
        ...
        [SecurityCritical]
        internal static extern SafeMemoryMappedFileHandle CreateFileMapping(SafeFileHandle hFile, IntPtr lpAttributes,
            FileMapProtection fProtect, int dwMaxSizeHi, int dwMaxSizeLo, string lpName);

        internal static SafeMemoryMappedFileHandle CreateFileMapping(SafeFileHandle hFile, FileMapProtection flProtect,
        ...
        internal static SafeMemoryMappedViewHandle MapViewOfFile(SafeMemoryMappedFileHandle hFileMappingObject,
