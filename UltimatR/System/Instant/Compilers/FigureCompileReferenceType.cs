...
// <copyright file="FigureCompileReferenceType.cs" company="UltimatR.Core">
...
namespace System.Instant
{
    ...
    /// <summary>
    /// Class FigureCompileReferenceType.
    ...
    public class FigureCompileReferenceType : FigureCompiler
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FigureCompileReferenceType" /> class.
        /// </summary>
                ...
                if (mutator != null)
                {
                    ...
                    if (args.Length == 2 && argTypes[0] == typeof(string) && argTypes[1] == typeof(object))
                    {
                        ...
                        for (int i = 0; i < length; i++)
                        {
                            ...
                            il.Emit(OpCodes.Ldarg_0); 
                            il.Emit(OpCodes.Ldarg_2); 
                            il.Emit(rubricBuilders[i].Type.IsValueType ? OpCodes.Unbox_Any : OpCodes.Castclass, rubricBuilders[i].Type); 
                            il.Emit(OpCodes.Stfld, rubricBuilders[i].Field.RubricInfo); 
                            il.Emit(OpCodes.Ret);
                        }
                    }
