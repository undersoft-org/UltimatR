        ...
        )
        {
            ...
            foreach (PropertyInfo info in map)
            {
                ...
                if (value != null)
                {
                    if (info.PropertyType == typeof(byte[]))
                        if (value.GetType() == typeof(List<object>))
                            ...
                            value = ((object[])value)
                                .Select(symbol => Convert.ToByte(symbol))
                                .ToArray();
                    else if (info.PropertyType == typeof(Ussn))
                        value = new Ussn(value.ToString());
                    ...
                    else if (info.PropertyType == typeof(EthContext))
                    {
                        object inst = new object();
                        Dictionary<string, object> subbag = (Dictionary<string, object>)value;
                        IEnumerable<PropertyInfo> submap = PrepareInstance(
                            out inst,
                            typeof(EthContext)
                        );
