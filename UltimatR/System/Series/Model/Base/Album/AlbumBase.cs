...
// <copyright file="AlbumBase.cs" company="UltimatR.Core">
...
namespace System.Series
{
    ...
    public class AlbumBase<V> : KeyedSet<V>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlbumBase{V}" /> class.
        /// </summary>
        ...
        public AlbumBase(IEnumerable<IUnique<V>> collection, int capacity = 17, bool repeatable = false, HashBits bits = HashBits.bit64)
        ...
        /// <param name="repeatable">if set to <c>true</c> [repeatable].</param>
        /// <param name="bits">The bits.</param>
        public AlbumBase(IEnumerable<V> collection, int capacity = 17, bool repeatable = false, HashBits bits = HashBits.bit64) 
            : this(repeatable, capacity, bits)
        {           
            foreach(var c in collection)
                InnerAdd(c);
